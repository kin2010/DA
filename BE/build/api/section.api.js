...
var SectionService = /** @class */ (function () {
    ...
    var _a;
    _a = SectionService;
    SectionService.update = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
        var id, other, out, chapter, error_1;
        var _b;
        return __generator(_a, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, models_1.Section.findByIdAndUpdate(id, __assign({}, other), {
                            new: true,
                        })];
    ...
    SectionService.add = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
        var _b, course, other, cc, data, section, error_2;
        var _c;
        return __generator(_a, function (_d) {
            switch (_d.label) {
                case 0:
                    _d.trys.push([0, 5, , 6]);
                    _b = req === null || req === void 0 ? void 0 : req.body, course = _b.course, other = __rest(_b, ["course"]);
                ...
                case 1:
                    ...
                    data = __assign(__assign({}, other), { course: course });
                ...
                case 3:
                    section = _d.sent();
                    console.log(__spreadArray(__spreadArray([], cc.sections, true), [section === null || section === void 0 ? void 0 : section._id], false));
    ...
    SectionService.getChapters = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
        var idCourse, cc, chapter, error_3;
    ...
    SectionService.getChapter = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
        var id, chapter, chapterRes, error_4;
        return __generator(_a, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 3, , 4]);
